...
export class CoreModule {
    public static forRoot(options: { database: TypeOrmModuleOptions }): DynamicModule {
        const imports: ModuleMetadata['imports'] = [TypeOrmModule.forRoot(options.database)]
    ...
    public static forRepository<T extends Type<any>>(repositories: T[], dataSourceName?: string): DynamicModule {
